...
A wrapper to work with de [Spotify Web Api](https://developer.spotify.com/web-api/)
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/guibas741/spotify-wrapper/tags).

## Authors

| ![Guilherme Augusto](https://avatars2.githubusercontent.com/u/24190696?s=460&v=4)|
|:---------------------:|
|  [Guilherme Augusto](https://github.com/guibas741/)   |

See also the list of [contributors](https://github.com/guibas741/spotify-wrapper/contributors) who participated in this project.
